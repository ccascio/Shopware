...
class Post2View: UIViewController {
    ...
    init(barcode: String) {
        super.init(nibName: "Post2View", bundle: nil)
	...
	override func viewDidLoad() {
		...
		navigationItem.leftBarButtonItem = UIBarButtonItem(image: UIImage(systemName: "xmark"), style: .plain, target: self, action: #selector(done(_:)))
	...
	func loadData() {
        ...
        imagePost.image = product.image
		imageUser.image = product.image
		productName.text = "Brian Elwood"
		brand.text = "2 min ago"
